## Project Overview
This project predicts time-to-hire (in days) for job vacancies using historical recruitment data. The goal is to understand which factors influence hiring duration and evaluate how accurately it can be predicted using regression models.
